...
class GuagePainter extends CustomPainter {
  ...
  double currentSpeed;
  final ui.Color? outPrimaryColor;
  final ui.Color? inPrimaryColor;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final speedPathFillPaint = Paint()
      ...
      ..shader = ui.Gradient.radial(
        ...
        [
          ...
          secondaryColor ?? const ui.Color.fromARGB(156, 226, 226, 200),
        ],
        [0.8, 1],
      );

    final outerPathPaint = Paint()
      ..style = PaintingStyle.fill
      ..shader = ui.Gradient.radial(
        center,
        radius,
        [
          const ui.Color(0xFF000000),
          outPrimaryColor ?? const ui.Color(0xFF787878),
        ],
        [0.8, 0.9],
      );
    ...
    final innerPathPaint = Paint()
      ...
      ..shader = ui.Gradient.radial(
        ...
        [
          const ui.Color(0xFF000000),
          inPrimaryColor ?? const ui.Color(0xFF434343),
        ],
        [0.65, 0.9],
      );

    final outerPathPaintRed = Paint()
      ..style = PaintingStyle.fill
      ..shader = ui.Gradient.radial(
        center,
        radius,
    ...
    canvas.drawLine(
        center,
        Offset(
          center.dx + radius * cos(GuageProps.majorAngleRad),
